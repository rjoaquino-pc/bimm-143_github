...
author: "Paige Contreras (PID:A16850883)"
format: pdf
toc: true
---
...
> **N.B.** We never run an `installl.packages()` in a code chunk otherwise we will re-install needlessly every time we render our document. 
