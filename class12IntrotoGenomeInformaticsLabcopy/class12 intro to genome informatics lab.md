...
![](class12-intro-to-genome-informatics-lab_files/figure-commonmark/unnamed-chunk-10-1.png)

``` r
boxplot2 <- boxplot(exp ~ geno, data = expr)
```

![](class12-intro-to-genome-informatics-lab_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](class12-intro-to-genome-informatics-lab_files/figure-commonmark/unnamed-chunk-14-1.png)
