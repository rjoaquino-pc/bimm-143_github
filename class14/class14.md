...
> Q. Q. Improve this plot by completing the below code, which adds
...
```
    ...
    Info: Working in directory /Users/paigecontreras/BIMM 143/bimm143_github/class14
...
![](hsa00500.pathview.png) ![](hsa00330.pathview.png)
![](hsa04910.pathview.png) ![](hsa04510.pathview.png)
...
![](hsa04672.pathview.png) ![](hsa04340.pathview.png)
![](hsa04916.pathview.png) ![](hsa04612.pathview.png)
...
The intestinal immune network has the most significant pathway, with a
p-value of. 0.01006194. The pathways do not match in KEGG results, when
ran again, instead the msot significant is hsa00500 Starch and sucrose
metabolism with a p value of 0.007619766. Factors that can cause
differences between the two methods include, KEGG pathways varying when
being used, and GAGE outputting varying results.
